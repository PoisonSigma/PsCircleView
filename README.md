...
![image-20260225165200914](./i/image-20260225165200914.png)

![image-20260225165234580](./i/image-20260225165234580.png)
...
let psCircleV2 = PsCircleView()//设置成成员变量,防止被释放
...
override func viewDidLoad() {
        super.viewDidLoad()
        view.addSubview(psCircleV)
        psCircleV.frame = CGRect(x: 20, y: 400, width: view.bounds.width - 40, height: 300)
