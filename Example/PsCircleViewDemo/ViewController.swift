...
//  PsCircleViewDemo
//
//  Created by Poision on 2021/5/21.
//

import UIKit

class ViewController: UIViewController {
    @IBOutlet weak var psCircleV: PsCircleView!
    let psCircleV2 = PsCircleView()
    ...
    override func viewDidLoad() {
        ...
        psCircleV.views = [vc1.view,vc2.view,vc3.view] //视图数组 Views array
        psCircleV.isVertical = false //是否是垂直滚动 is vertical scrolling
        psCircleV.autoScroll = true    //是否自动滚动 is can scroll
        psCircleV.pageControl.isHidden = false //是否显示页面 , page is hidden
        psCircleV.timeInterval = 2 //时间间隔 time interval
        psCircleV.didSelect { index in  //点击回调  , click block
            print("水平视图选中了\(index)行")
        }
        psCircleV.titles = ["第一个","第二个","第三个"] //标题 title
        ...
        view.addSubview(psCircleV2)
        psCircleV2.views = [v1,v2,v3]
        psCircleV2.isVertical = true
        psCircleV2.autoScroll = true
        psCircleV2.timeInterval = 0.5
        psCircleV2.didSelect { index in
    ...
    override func viewDidLayoutSubviews() {
        ...
        psCircleV2.frame = CGRect(x: 20, y: 400, width: view.bounds.width - 40, height: 300)
    }
